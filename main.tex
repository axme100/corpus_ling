...
\begin{center}
\begin{itemize}
\item In an academic blog post titled \textit{Why Chomsky was wrong about corpus linguistics} \citeA{wallis_why_2016} talks about why Chomsky \textbf{(but also Sinclair)} got their theories wrong.
\begin{itemize}
...
\end{itemize}
\item Today, there are few theoretical linguistics who rely on introspection, value-judgments, and few applied linguistics lack theory in their analysis	.
\end{itemize}
\end{center}
\end{frame}
